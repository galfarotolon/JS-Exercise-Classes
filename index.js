...
class Instructor extends Lambdasian {
  ...
  // about() {
  //   return `Hello, my name is ${this.name}, I am ${this.age} years old and I love ${this.specialty}. My
  //   favorite language is ${this.favLanguage}. ${this.catchPhrase}!!!`
  // }
}
...
// console.log(instructorOne.about());
